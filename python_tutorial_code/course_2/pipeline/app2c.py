# For module 2 session 9, Will's published code on Github came in 2 files, this is the 2nd file
# Will had called his 2nd file:    "session_2_tidying.py"
...
the 'if' where we run the app from.

In a larger project we'd put these functions in seprate files
...
# Functions
# Let's give this function a name specific to the data it ingests, in case we add the ability
