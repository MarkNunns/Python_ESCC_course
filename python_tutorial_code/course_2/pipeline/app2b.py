# For module 2 session 9, Will's published code on Github came in 2 files, this is the 1st file.
# Will had called his 1st file:    "session_2_appifying.py"

# Will's code:  https://github.com/data-to-insight/ERN-sessions/tree/main/No%20Local%20Python
...
# The first bit of this app works OK, but the graphics are not working and this throws up error messages.
# do we need to install anything (plotly related) in the Terminal to get the graphics working??
# is the requirements.txt file correct (this mentions plotly)?
# look back at app1.py code, as this does file does run correctly (graphics are generated)
...
# import numpy as np            is this needed? MN added this line as it was in the app1.py file (which did work)
...
def ingest_cin_data(input_files):
    ...
    with the key being the filename minus years and extension.
    The table name is kept to help the merge later.
    """
    dfs = {}
...
# the wide-form file has more fields than the long-form file
    st.download_button(
